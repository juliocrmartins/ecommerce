...
$app->post("/login", function(){
	...
	{
 		User::setMsgError($ex->getMessage());
	}
...
$app->post("/register", function(){
	...
	{
		User::setMsgErrorRegister("Este endereço de e-mail já está sendo usado por outro usuário.");
		header("Location: /login");
		exit;
	}
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["endereco2"] = utf8_decode($order->getdescity() . " - " . $order->getdesstate() . " -  CEP: " . $order->getdeszipcode());
